Definition: for now, land consumption is calculated as the summed area of land use objects such as buildings, streets, parking lots, and other built-up areas.
...
Methodology: the plugin requests OSM data for the area of interest, calculates the area of different land use classes and objects, and then summarizes the data in a tabular format..