...
**Consumed Land**
- Developed land including buildings, roads, parking areas, and other built infrastructure, but does not include agricultural or semi-natural areas.
...
6. **Other**: A catch-all category for land use types not covered by the above classes. Other is excluded from consumed land calculations.
...
1. **Residential Areas**: Includes land primarily used for housing and dwellings. OSM tag: `landuse=residential`
2. **Commercial Areas**: Includes land used for business, retail, and service-related functions. OSM tags: `landuse=commercial` or `landuse=retail`
3. **Industrial Areas**: Includes land designated for manufacturing, warehousing, or other industrial activities. OSM tag: `landuse=industrial`
4. **Infrastructural and Institutional Areas**: Covers land used for public infrastructure and institutional functions such as education and transport. OSM tag: `landuse=industrial`
5. **Agricultural Areas**: Represents land used for farming, horticulture, and related rural activities. OSM landuse values: `allotments`, `farmland`, `farmyard`, `meadow`, `orchard`, `plant_nursery`, `vineyard`
6. **Other Land Uses**: A catch-all category for miscellaneous land use classes that do not fit into the categories above.
